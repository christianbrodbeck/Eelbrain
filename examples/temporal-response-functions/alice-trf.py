...
TRFs for Alice EEG Dataset
==========================

This example shows how to estimate a TRF,
...
###############################################################################
# Plot EEG alongside the predictor for the sound that was presented
...
# The :fun:`boosting` function uses *K*-fold cross-validation.
# Cross-validation is enabled with the `test=True` parameter, 
# and *K* is the `partitions` parameter.
...
###############################################################################
# Now use the decoder to reconstruct the envelope of the last trial
