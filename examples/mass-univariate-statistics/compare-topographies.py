...
p = plot.TopoArray('eeg', 'cloze_cat', data=ds, axh=2, axw=10, t=[0.120, 0.200, 0.280])
...
test.ANOVA('eeg', 'cloze_cat * sensor * subject', data=ds_topography)
...
p = plot.Topomap('eeg', 'time', data=ds_times, ncol=2, title="Original")
p = plot.Topomap(topography, 'time', data=ds_times, ncol=2, title="Normalized")
