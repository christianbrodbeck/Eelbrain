...
def test_layout():
    ...
    for nax in xrange(1, 100):
        assert_layout_ok(nax, 1.5, 2, w=5)
        assert_layout_ok(nax, 1.5, 2, h=5)
        assert_layout_ok(nax, 1.5, 2, axw=5)
        assert_layout_ok(nax, 1.5, 2, axh=5)
        assert_layout_ok(nax, 1.5, 2, axw=5, w=20)
        assert_layout_ok(nax, 1.5, 2, axw=5, h=20)
        assert_layout_ok(nax, 1.5, 2, axh=5, w=20)
        assert_layout_ok(nax, 1.5, 2, axh=5, h=20)
